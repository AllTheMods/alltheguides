...
Additionally, some launchers may install and use the appropriate version of [Java](general/java.md), though make sure you’re using the correct version of [Java](general/java.md) for the **Minecraft** version of the pack installed.
