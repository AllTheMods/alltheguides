...
*   **Vein Naming:** GregTech veins often have names like "Iron Vein," while TFC defaults are simpler (e.g., "Native Copper Vein"). (GT) denotes veins primarily from GregTech style generation. (TFC) denotes TerraFirmaCraft default veins/deposits.
*   **Multiple Ores:** Many GT veins contain multiple valuable ores. Check the "Common Ores in Vein" column carefully.

---
### Copper (Cu) Ores

| Vein Name / Type      | Common Ores in This Vein (Gravitas²)                         | Y-Level Range | Host Rock Types (TFC Specific Names)                        | Notes & Tips                                                      |
|-----------------------|--------------------------------------------------------------|---------------|-------------------------------------------------------------|-------------------------------------------------------------------|
| Native Copper (TFC)   | `Native Copper`                                              | y > 40        | `Rhyolite`, `Basalt`, `Andesite`, `Dacite` (Igneous Extrusive)  | Common early copper. Also by panning.                             |
| Tetrahedrite (TFC)    | `Tetrahedrite` (Copper ore)                                  | Any           | `Quartzite`, `Slate`, `Phyllite`, `Schist`, `Gneiss`, `Marble` (Metamorphic) | Deeper veins often richer.                                        |
| Malachite (TFC)       | `Malachite` (Copper ore)                                     | Any           | `Limestone`, `Chalk`, `Dolomite` (Sedimentary); `Marble` (Metamorphic) | Deeper veins often larger/richer. Found with `Limestone`.         |
| Copper Vein (GT)      | `Chalcopyrite`, `Iron`, `Pyrite`, `Copper`                   | y=-40 to y=10 | `Diorite`, `Granite`                                        |                                                                   |
...
| Vein Name / Type      | Common Ores in This Vein (Gravitas²)                         | Y-Level Range | Host Rock Types (TFC Specific Names)                           | Notes & Tips                                         |
|-----------------------|--------------------------------------------------------------|---------------|----------------------------------------------------------------|------------------------------------------------------|
| Cassiterite (TFC)     | `Cassiterite` (Tin ore)                                      | y > 80        | `Granite`, `Diorite`, `Gabbro` (Igneous Intrusive in uplift/dikes) | TFC default Tin. Also by panning.                    |
| Cassiterite Vein (GT) | `Tin`, `Cassiterite`                                         | y=10 to y=80  | `Granite`, `Diorite`, `Gabbro`                                 |                                                      |
| Garnet Tin Vein (GT)  | `Cassiterite Sand`, `Garnet Sand`, `Asbestos`, `Diatomite`   | y=30 to y=60  | `Limestone`, `Chalk`                                           | Source of Tin and industrial minerals.             |
...
| Vein Name / Type   | Common Ores in This Vein (Gravitas²)                               | Y-Level Range | Host Rock Types (TFC Specific Names)                                          | Notes & Tips                                           |
|--------------------|--------------------------------------------------------------------|---------------|-------------------------------------------------------------------------------|--------------------------------------------------------|
| Hematite (TFC)     | `Hematite` (Iron ore)                                              | Near Surface  | `Rhyolite`, `Basalt`, `Andesite`, `Dacite` (Igneous Extrusive)                  | Large TFC iron veins.                                  |
| Magnetite (TFC)    | `Magnetite` (Iron ore)                                             | Near Surface  | `Shale`, `Claystone`, `Limestone`, `Conglomerate`, `Dolomite`, `Chert`, `Chalk` (Sedimentary) | Large TFC iron veins.                                  |
| Limonite (TFC)     | `Limonite` (Iron ore)                                              | Near Surface  | `Shale`, `Claystone`, `Limestone`, `Conglomerate`, `Dolomite`, `Chert`, `Chalk` (Sedimentary) | Large TFC iron veins.                                  |
...
| Magnetite Vein (GT)| `Magnetite`, `Vanadium Magnetite`, `Gold`                          | y=10 to y=60  | `Basalt`, `Rhyolite`, `Andesite`, `Dacite`                                    | GT vein, also source of `Gold` and `Vanadium`.       |
...
| Vein Name / Type      | Common Ores in This Vein (Gravitas²)                         | Y-Level Range | Host Rock Types (TFC Specific Names)                                                    | Notes & Tips                                                     |
|-----------------------|--------------------------------------------------------------|---------------|-----------------------------------------------------------------------------------------|------------------------------------------------------------------|
| Native Gold (TFC)     | `Native Gold`                                                | y < 70        | `Rhyolite`, `Basalt`, `Andesite`, `Dacite` (Igneous Extrusive); `Granite`, `Diorite`, `Gabbro` (Igneous Intrusive) | Deeper veins larger/richer. Also by panning. Often with GT Magnetite Vein. |
| Native Silver (TFC)   | `Native Silver`                                              | y > 90 (poor) or y < 20 (rich) | `Granite`, `Diorite` (uplift); `Granite`, `Diorite`, `Schist`, `Gneiss` (deep)        | TFC default. Also by panning.                                    |
| Galena Vein (GT)      | `Galena` (Lead/Silver ore), `Silver`, `Lead`                 | y=-15 to y=45 | `Granite`, `Gneiss`                                                                     | Primary GT Lead and Silver source.                               |

---
### Zinc (Zn), Nickel (Ni), Bismuth (Bi) Ores

| Vein Name / Type   | Common Ores in This Vein (Gravitas²)                         | Y-Level Range | Host Rock Types (TFC Specific Names)                                                      | Notes & Tips                                       |
|--------------------|--------------------------------------------------------------|---------------|-------------------------------------------------------------------------------------------|----------------------------------------------------|
| Sphalerite (TFC)   | `Sphalerite` (Zinc ore)                                      | Near surface (poor) or deep (rich) | `Rhyolite`, `Basalt`, `Andesite`, `Dacite` (Igneous Extrusive - poor); `Granite`, `Diorite`, `Gabbro` (Igneous Intrusive - rich); `Quartzite` (Metamorphic, per quest) | TFC default.                                       |
| Garnierite (TFC)   | `Garnierite` (Nickel ore)                                    | y < 0         | `Gabbro` (primarily); `Granite`, `Diorite` (Igneous Intrusive - rarer)                     | TFC default.                                       |
...
| Bismuthinite (TFC) | `Bismuthinite` (Bismuth ore)                                 | Near surface or deep | `Shale`, `Claystone`, etc. (Sedimentary - near surface); `Granite`, `Diorite`, `Gabbro` (Igneous Intrusive - deep, richer) | TFC default. Needed for `Bismuth Bronze`.        |
...
| Vein Name / Type      | Common Ores in This Vein (Gravitas²)                         | Y-Level Range | Host Rock Types (TFC Specific Names)                                          | Notes & Tips                           |
|-----------------------|--------------------------------------------------------------|---------------|-------------------------------------------------------------------------------|----------------------------------------|
| Lignite (TFC)         | `Lignite` (Low-grade coal)                                   | Near Surface  | `Shale`, `Claystone`, `Limestone`, `Conglomerate`, `Dolomite`, `Chert`, `Chalk` (Sedimentary) | Large, flat deposits. Fuel.            |
| Bituminous Coal (TFC) | `Bituminous Coal` (Mid-grade coal)                           | Near Surface  | `Shale`, `Claystone`, `Limestone`, `Conglomerate`, `Dolomite`, `Chert`, `Chalk` (Sedimentary) | Large, flat deposits. Better fuel.     |
...
| Vein Name / Type         | Common Ores in This Vein (Gravitas²)                         | Y-Level Range | Host Rock Types (TFC Specific Names)                                          | Notes & Tips                                                     |
|--------------------------|--------------------------------------------------------------|---------------|-------------------------------------------------------------------------------|------------------------------------------------------------------|
| Diamond Vein (GT)        | `Graphite`, `Diamond`, `Coal`                                | y=-65 to y=10 | `Gabbro`                                                                      | GT Kimberlite pipes. Primary source of `Diamonds` and `Graphite`.|
| Emerald (TFC)            | `Emerald`                                                    | Any           | `Granite`, `Diorite`, `Gabbro` (Igneous Intrusive)                              | Thin, tall vertical formations in TFC.                           |
...
| Amethyst (TFC Deposit)   | `Amethyst`                                                   | y > 40        | `Shale`, `Claystone`, etc. (Sedimentary); `Slate`, `Marble`, etc. (Metamorphic) - beneath rivers | TFC default.                                                     |
| Opal (TFC Deposit)       | `Opal`                                                       | y > 40        | `Shale`, `Claystone`, etc. (Sedimentary); `Rhyolite`, `Basalt`, etc. (Igneous Extrusive) - beneath rivers | TFC default.                                                     |
...
| Vein Name / Type         | Common Ores in This Vein (Gravitas²)                               | Y-Level Range | Host Rock Types (TFC Specific Names)                                                                  | Notes & Tips                                                                                 |
|--------------------------|--------------------------------------------------------------------|---------------|-------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------|
| Apatite Vein (GT)        | `Apatite`, `Tricalcium Phosphate`, `Pyrochlore`                    | y=10 to y=80  | `Basalt`, `Rhyolite`, `Andesite`, `Dacite`, `Granite`, `Gabbro`, `Diorite`                           | GT source of Phosphate (for fertilizer).                                                     |
...
| Kaolinite (TFC Deposit)  | `Kaolinite Clay`                                                   | High Altitudes| Special Environmental: Plateaus, Old Mountains, Highlands (Temp >= 18°C, Rainfall >= 300mm)        | Used for Fire Clay. Blood Lily flower grows on it. Not a typical "vein."                   |
| Graphite (TFC Deposit)   | `Graphite`                                                         | y < 60        | `Gneiss`, `Marble`, `Quartzite`, `Schist` (Metamorphic)                                               | Used for Fire Clay. Also found in GT Diamond Veins.                                          |
| Cinnabar (TFC Deposit)   | `Cinnabar`                                                         | Deep          | `Quartzite`, `Granite`, `Phyllite`, `Schist`                                                          | Ground for Redstone Dust. Also in GT Redstone/Thorium veins.                                 |
| Cryolite (TFC Deposit)   | `Cryolite`                                                         | Deep          | `Granite`, `Diorite` (Igneous Intrusive)                                                              | Ground for Redstone Dust.                                                                    |
| Saltpeter (TFC Deposit)  | `Saltpeter`                                                        | Near Surface  | `Shale`, `Claystone`, `Limestone`, `Conglomerate`, `Dolomite`, `Chert`, `Chalk` (Sedimentary)        | Ground for Gunpowder. Large flat deposits.                                                   |
| Sulfur (TFC Deposit)     | `Sulfur`                                                           | Near Lava Lvl | Any Metamorphic (`Quartzite`, `Slate`, etc.) or Igneous Intrusive (`Granite`, `Diorite`, `Gabbro`) | Ground for Gunpowder. Sparse but large veins.                                                |
| Sylvite (TFC Deposit)    | `Sylvite`                                                          | Near Surface  | `Shale`, `Claystone`, `Chert` (Sedimentary)                                                         | Ground for Fertilizer. Large flat deposits.                                                  |
| Borax (TFC Deposit)      | `Borax`                                                            | Near Surface  | `Claystone`, `Limestone`, `Shale` (Sedimentary)                                                     | Ground for Flux. Large flat deposits.                                                        |
| Gypsum (TFC Deposit)     | `Gypsum`                                                           | Near Surface  | `Shale`, `Claystone`, `Limestone`, `Conglomerate`, `Dolomite`, `Chert`, `Chalk` (Sedimentary)        | Decorative (Alabaster). Large flat deposits. Also in GT Mineral Sand Veins.                  |
| Halite (TFC Deposit)     | `Halite` (Rock Salt)                                               | Near Surface  | `Shale`, `Claystone`, `Limestone`, `Conglomerate`, `Dolomite`, `Chert`, `Chalk` (Sedimentary)        | Ground for Salt (Preservative). Large flat deposits. Also in GT Salts Veins.                 |
...
| Vein Name / Type     | Common Ores in This Vein (Gravitas²)                               | Y-Level Range | Host Rock Types (TFC Specific Names)                                          | Notes & Tips                                                     |
|----------------------|--------------------------------------------------------------------|---------------|-------------------------------------------------------------------------------|------------------------------------------------------------------|
| Thorium Vein (GT)    | `Thorium`, `Cinnabar`, `Uraninite`                                 | y=-50 to y=25 | `Basalt`, `Rhyolite`, `Dacite`, `Andesite`                                    | GT source for radioactive materials.                             |
| Redstone Vein (GT)   | `Redstone`, `Ruby`, `Cinnabar`, `Thorium`                          | y=-65 to y=-10| `Rhyolite`, `Basalt`, `Andesite`, `Dacite`, `Quartzite`, `Shale`              | Primary GT `Redstone` source, also `Ruby`.                       |
