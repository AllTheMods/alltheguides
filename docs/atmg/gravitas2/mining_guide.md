...
*   **Vein Naming:** GregTech veins often have names like "Iron Vein," while TFC defaults are simpler (e.g., "Native Copper Vein"). (GT) denotes veins primarily from GregTech style generation. (TFC) denotes TerraFirmaCraft default veins. Some TFC minerals spawn as deposits, not typical veins.
*   **Multiple Ores:** Many GT veins contain multiple valuable ores. Check the "Common Ores in Vein" column carefully.

---
### Copper (Cu) Ores

| Vein Name / Type      | Common Ores in This Vein (Gravitas²)                         | Y-Level Range | Host Rock Types (TFC)                                          | Notes & Tips                                                      |
|-----------------------|--------------------------------------------------------------|---------------|----------------------------------------------------------------|-------------------------------------------------------------------|
| Native Copper (TFC)   | `Native Copper`                                              | y > 40        | Igneous Extrusive (Rhyolite, Basalt, Andesite, Dacite)           | Common early copper. Also by panning.                             |
...
| Malachite (TFC)       | `Malachite` (Copper ore)                                     | Any           | Sedimentary (Limestone, Chalk, Dolomite), Metamorphic (Marble)   | Deeper veins often larger/richer. Often with `Limestone`.         |
...
| Vein Name / Type      | Common Ores in This Vein (Gravitas²)                         | Y-Level Range | Host Rock Types (TFC)                                                 | Notes & Tips                                         |
|-----------------------|--------------------------------------------------------------|---------------|-----------------------------------------------------------------------|------------------------------------------------------|
| Cassiterite (TFC)     | `Cassiterite` (Tin ore)                                      | y > 80        | Igneous Intrusive (Granite, Diorite, Gabbro) in uplift/dikes      | TFC default Tin. Also by panning.                    |
...
| Vein Name / Type   | Common Ores in This Vein (Gravitas²)                               | Y-Level Range | Host Rock Types (TFC)                                                      | Notes & Tips                                           |
|--------------------|--------------------------------------------------------------------|---------------|----------------------------------------------------------------------------|--------------------------------------------------------|
| Hematite (TFC)     | `Hematite` (Iron ore)                                              | Near Surface  | Igneous Extrusive (Rhyolite, Basalt, Andesite, Dacite)                       | Large TFC iron veins.                                  |
...
| Vein Name / Type      | Common Ores in This Vein (Gravitas²)                         | Y-Level Range | Host Rock Types (TFC)                                                            | Notes & Tips                                                     |
|-----------------------|--------------------------------------------------------------|---------------|----------------------------------------------------------------------------------|------------------------------------------------------------------|
| Native Gold (TFC)     | `Native Gold`                                                | y < 70        | Igneous Extrusive, Igneous Intrusive                                               | Deeper veins larger/richer. Also by panning. Often with GT Magnetite Vein. |
...
| Vein Name / Type   | Common Ores in This Vein (Gravitas²)                         | Y-Level Range | Host Rock Types (TFC)                                                              | Notes & Tips                                       |
|--------------------|--------------------------------------------------------------|---------------|------------------------------------------------------------------------------------|----------------------------------------------------|
| Sphalerite (TFC)   | `Sphalerite` (Zinc ore)                                      | Near surface (poor) or deep (rich) | Igneous Extrusive (poor); Igneous Intrusive (rich); (Questbook also lists `Quartzite`) | TFC default.                                       |
| Garnierite (TFC)   | `Garnierite` (Nickel ore)                                    | y < 0         | `Gabbro` (primarily); any Igneous Intrusive (rarer)                                  | TFC default.                                       |
...
| Bismuthinite (TFC) | `Bismuthinite` (Bismuth ore)                                 | Near surface or deep | Sedimentary (near surface); Igneous Intrusive (deep, richer)                           | TFC default. Needed for `Bismuth Bronze`.        |
...
| Vein Name / Type      | Common Ores in This Vein (Gravitas²)                         | Y-Level Range | Host Rock Types (TFC)   | Notes & Tips                           |
|-----------------------|--------------------------------------------------------------|---------------|-------------------------|----------------------------------------|
| Lignite (TFC)         | `Lignite` (Low-grade coal)                                   | Near Surface  | Sedimentary             | Large, flat deposits. Fuel.            |
...
| Amethyst (TFC Deposit)   | `Amethyst`                                                   | y > 40        | Sedimentary, Metamorphic (beneath rivers)                      | TFC default.                                                     |
| Opal (TFC Deposit)       | `Opal`                                                       | y > 40        | Sedimentary, Igneous Extrusive (beneath rivers)                | TFC default.                                                     |
...
| Kaolinite (TFC Deposit)  | `Kaolinite Clay`                                                   | High Altitudes| Special: Plateaus, Old Mountains, Highlands (Temp >= 18°C, Rainfall >= 300mm)         | Used for Fire Clay. Blood Lily flower grows on it. Not a typical "vein."                   |
| Graphite (TFC Deposit)   | `Graphite`                                                         | y < 60        | `Gneiss`, `Marble`, `Quartzite`, `Schist`                                              | Used for Fire Clay. Also found in GT Diamond Veins.                                          |
...
| Cryolite (TFC Deposit)   | `Cryolite`                                                         | Deep          | `Granite`, `Diorite`                                                                   | Ground for Redstone Dust.                                                                    |
| Saltpeter (TFC Deposit)  | `Saltpeter`                                                        | Near Surface  | Sedimentary                                                                            | Ground for Gunpowder. Large flat deposits.                                                   |
| Sulfur (TFC Deposit)     | `Sulfur`                                                           | Near Lava Lvl | Any Metamorphic or Igneous Intrusive                                                   | Ground for Gunpowder. Sparse but large veins.                                                |
| Sylvite (TFC Deposit)    | `Sylvite`                                                          | Near Surface  | `Shale`, `Claystone`, `Chert`                                                          | Ground for Fertilizer. Large flat deposits.                                                  |
| Borax (TFC Deposit)      | `Borax`                                                            | Near Surface  | `Claystone`, `Limestone`, `Shale`                                                      | Ground for Flux. Large flat deposits.                                                        |
| Gypsum (TFC Deposit)     | `Gypsum`                                                           | Near Surface  | Sedimentary                                                                            | Decorative (Alabaster). Large flat deposits. Also in GT Mineral Sand Veins.                  |
| Halite (TFC Deposit)     | `Halite` (Rock Salt)                                               | Near Surface  | Sedimentary                                                                            | Ground for Salt (Preservative). Large flat deposits. Also in GT Salts Veins.                 |
