...
| Animal    | Biome             | Temp °C      | Rainfall mm | Diet                                              | Primary Products/Use | Breeding             | Children | Pregnancy            | Max Litters         | Adulthood | Production Cycle                 | Other Notes                                        |
|-----------|-------------------|--------------|-------------|---------------------------------------------------|----------------------|----------------------|----------|----------------------|---------------------|-----------|----------------------------------|----------------------------------------------------|
| Pig       | Mild forests      | -10 to 35    | ≥ 200       | Any food (even rotten)                            | Meat                 | Mammal               | 1-10     | 19 days              | 6                   | 80 days   | ---                              | Male pigs have tusks.                              |
| Cow       | Most climates     | -10 to 35    | ≥ 250       | `Grains` (rotten ok)                              | Milk, Meat           | Mammal, Dairy        | 1-2      | 58 days              | 13                  | 192 days  | Milk daily                       | Can be milked 128 times if never bred.             |
| Goat      | Moderate climates | -12 to 25    | ≥ 300       | `Grains`, `Fruits`, `Vegetables` (rotten ok)        | Milk, Meat           | Mammal, Dairy        | 1-2      | 32 days              | 6                   | 96 days   | Milk every 3 days                | Can be milked 60 times if never bred.              |
| Yak       | Cold climates     | ≤ -11        | ≥ 100       | Fresh `Grains` only                               | Milk, Meat           | Mammal, Dairy        | 1        | 64 days              | 23                  | 180 days  | Milk daily                       | Can be milked 230 times if never bred.             |
| Alpaca    | Moderate climates | -8 to 20     | ≥ 250       | `Grains`, `Fruits`                                | Wool, Meat           | Mammal, Wooly        | 1-2      | 36 days              | 13                  | 98 days   | Grows wool every 6 days          | Can be sheared 128 times if never bred.            |
| Sheep     | Drier climates    | 0 to 35      | 70-300      | `Grains`                                          | Wool, Meat           | Mammal, Wooly        | 1-2      | 32 days              | 6                   | 56 days   | Grows wool every 9 days          | Can be sheared 60 times if never bred.             |
| Musk Ox   | Cold climates     | -25 to 0     | ≥ 100       | `Grains`                                          | Wool, Meat           | Mammal, Wooly        | 1        | 64 days              | 16                  | 168 days  | Grows wool every 96h (4 days)    | Sheared 160 times if never bred.                   |
| Chicken   | Warm forests      | ≥ 14         | ≥ 225       | `Grains`, `Fruits`, `Vegetables`, `Seeds` (rotten ok) | Eggs, Meat           | Oviparous (Nest Box) | 1 (egg)  | 8 days (hatch time)  | 100 eggs total      | 24 days   | Produces eggs every 30 hours     | ---                                                |
| Duck      | Most plains       | -25 to 30    | ≥ 100       | `Grains`, `Fruits`, `Vegetables`, `Bread`, `Seeds`  | Eggs, Meat           | Oviparous (Nest Box) | 1 (egg)  | 8 days (hatch time)  | 72 eggs total       | 32 days   | Produces eggs every 32 hours     | ---                                                |
| Quail     | Colder climates   | -15 to 15    | ≥ 200       | `Grains`, `Fruits`, `Vegetables`, `Seeds` (rotten ok) | Eggs, Meat           | Oviparous (Nest Box) | 1 (egg)  | 8 days (hatch time)  | 48 eggs total       | 22 days   | Produces eggs every 28 hours     | ---                                                |
| Donkey    | Wetter plains     | ≥ -15        | 130-400     | `Grains`, `Fruits`                                | Transport (Chest), Meat | Mammal, Equine     | 1        | 19 days              | 6                   | 80 days   | ---                              | Rideable. Can carry a chest/barrel.                |
| Mule      | Plains            | ≥ -15        | 130-400     | `Grains`, `Fruits`                                | Transport (Chest), Meat | Mammal, Equine     | N/A      | N/A                  | N/A (Sterile)       | 80 days   | ---                              | Rideable. Can carry chest/barrel. Always male. Sterile. |
| Horse     | Plains            | ≥ -15        | 130-400     | `Grains`, `Fruits`                                | Transport, Meat      | Mammal, Equine     | 1        | 19 days              | 6                   | 80 days   | ---                              | Rideable.                                          |
