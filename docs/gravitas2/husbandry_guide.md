...
| Animal    | Spawning Conditions (Biome, Temp °C, Rainfall mm) | Diet                                    | Primary Products/Use | Breeding (Children, Pregnancy, Max Litters) | Adulthood | Production Cycle / Other Notes                                   |
|-----------|---------------------------------------------------|-----------------------------------------|----------------------|---------------------------------------------|-----------|------------------------------------------------------------------|
| Pig       | Mild forests; Temp -10 to 35°C; Rainfall ≥ 200mm  | Any food (even rotten)                  | Meat                 | 1-10 children; 19 days preg.; 6 litters     | 80 days   | Male pigs have tusks.                                            |
| Cow       | Most climates; Temp -10 to 35°C; Rainfall ≥ 250mm | `Grains` (rotten ok)                    | Milk, Meat           | 1-2 children; 58 days preg.; 13 litters     | 192 days  | Milk daily. Can be milked 128 times if never bred.               |
| Goat      | Moderate climates; Temp -12 to 25°C; Rainfall ≥ 300mm | `Grains`, `Fruits`, `Vegetables` (rotten ok) | Milk, Meat           | 1-2 children; 32 days preg.; 6 litters      | 96 days   | Milk every 3 days. Can be milked 60 times if never bred.         |
| Yak       | Cold climates; Temp ≤ -11°C; Rainfall ≥ 100mm     | Fresh `Grains` only                     | Milk, Meat           | 1 child; 64 days preg.; 23 litters          | 180 days  | Milk daily. Can be milked 230 times if never bred.               |
| Alpaca    | Moderate climates; Temp -8 to 20°C; Rainfall ≥ 250mm | `Grains`, `Fruits`                      | Wool, Meat           | 1-2 children; 36 days preg.; 13 litters     | 98 days   | Grows wool every 6 days. Can be sheared 128 times if never bred. |
| Sheep     | Drier climates; Temp 0 to 35°C; Rainfall 70-300mm | `Grains`                                | Wool, Meat           | 1-2 children; 32 days preg.; 6 litters      | 56 days   | Grows wool every 9 days. Can be sheared 60 times if never bred.  |
| Musk Ox   | Cold climates; Temp -25 to 0°C; Rainfall ≥ 100mm  | `Grains`                                | Wool, Meat           | 1 child; 64 days preg.; 16 litters          | 168 days  | Grows wool every 96 hours (4 days). Sheared 160 times if never bred. |
| Chicken   | Warm forests; Temp ≥ 14°C; Rainfall ≥ 225mm       | `Grains`, `Fruits`, `Vegetables`, `Seeds` (rotten ok) | Eggs, Meat           | Eggs hatch in 8 days; Lays 100 eggs total   | 24 days   | Produces eggs every 30 hours.                                    |
| Duck      | Most plains; Temp -25 to 30°C; Rainfall ≥ 100mm   | `Grains`, `Fruits`, `Vegetables`, `Bread`, `Seeds` | Eggs, Meat           | Eggs hatch in 8 days; Lays 72 eggs total    | 32 days   | Produces eggs every 32 hours.                                    |
| Quail     | Colder climates; Temp -15 to 15°C; Rainfall ≥ 200mm | `Grains`, `Fruits`, `Vegetables`, `Seeds` (rotten ok) | Eggs, Meat           | Eggs hatch in 8 days; Lays 48 eggs total    | 22 days   | Produces eggs every 28 hours.                                    |
| Donkey    | Wetter plains; Temp ≥ -15°C; Rainfall 130-400mm   | `Grains`, `Fruits`                      | Transport (Chest), Meat | 1 child; 19 days preg.; 6 litters           | 80 days   | Rideable. Can carry a chest/barrel.                              |
| Mule      | Plains; Temp ≥ -15°C; Rainfall 130-400mm          | `Grains`, `Fruits`                      | Transport (Chest), Meat | Sterile (product of Horse + Donkey)       | 80 days   | Rideable. Can carry a chest/barrel. Always male.                 |
| Horse     | Plains; Temp ≥ -15°C; Rainfall 130-400mm          | `Grains`, `Fruits`                      | Transport, Meat      | 1 child; 19 days preg.; 6 litters           | 80 days   | Rideable.                                                        |
