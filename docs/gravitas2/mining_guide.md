...
| Copper Vein (GT)      | `Chalcopyrite`, `Iron`, `Pyrite`, `Copper`                   | y=-40 to y=10 | `Diorite`, `Granite`                                        | `Chalcopyrite`/`Pyrite Nuggets`    |                                                                   |
| Copper Tin Vein (GT)  | `Chalcopyrite`, `Zeolite`, `Cassiterite` (Tin), `Realgar`    | y=-10 to y=160| `Basalt`, `Rhyolite`, `Andesite`, `Dacite`                  | `Chalcopyrite`/`Cassiterite Nuggets` | Excellent GT vein for early `Copper` and `Tin`.                   |
...
| Iron Vein (GT)     | `Goethite`, `Yellow Limonite`, `Hematite`, `Malachite`, `Chromite` | y=-10 to y=60 | `Basalt`, `Rhyolite`, `Andesite`, `Dacite`                                    | `Hematite`/`Limonite Nuggets`      | Diverse GT iron source, includes `Chromite`.           |
| Magnetite Vein (GT)| `Magnetite`, `Vanadium Magnetite`, `Gold`                          | y=10 to y=60  | `Basalt`, `Rhyolite`, `Andesite`, `Dacite`                                    | `Magnetite`/`Gold Nuggets`         | GT vein, also source of `Gold` and `Vanadium`.       |
...
| Galena Vein (GT)      | `Galena` (Lead/Silver ore), `Silver`, `Lead`                 | y=-15 to y=45 | `Granite`, `Gneiss`                                                                     | `Galena Nuggets` (if applicable)   | Primary GT Lead and Silver source.                               |
...
| Vein Name / Type      | Common Ores in This Vein (Gravitas²)                         | Y-Level Range | Host Rock Types (TFC Specific Names)                                          | Mineral Hint / Surface Indicator | Notes & Tips                           |
|-----------------------|--------------------------------------------------------------|---------------|-------------------------------------------------------------------------------|------------------------------------|----------------------------------------|
| Lignite (TFC)         | `Lignite` (Low-grade coal)                                   | Near Surface  | `Shale`, `Claystone`, `Limestone`, `Conglomerate`, `Dolomite`, `Chert`, `Chalk` (Sedimentary) | `Basalt` Hint                      | Large, flat deposits. Fuel.            |
| Bituminous Coal (TFC) | `Bituminous Coal` (Mid-grade coal)                           | Near Surface  | `Shale`, `Claystone`, `Limestone`, `Conglomerate`, `Dolomite`, `Chert`, `Chalk` (Sedimentary) | `Basalt` Hint                      | Large, flat deposits. Better fuel.     |
...
| Vein Name / Type         | Common Ores in This Vein (Gravitas²)                         | Y-Level Range | Host Rock Types (TFC Specific Names)                                          | Mineral Hint / Surface Indicator | Notes & Tips                                                     |
|--------------------------|--------------------------------------------------------------|---------------|-------------------------------------------------------------------------------|------------------------------------|------------------------------------------------------------------|
| Diamond Vein (GT)        | `Graphite`, `Diamond`, `Coal`                                | y=-65 to y=10 | `Gabbro`                                                                      | `Chalk` Hint (for Diamond)         | GT Kimberlite pipes. Primary source of `Diamonds` and `Graphite`.|
...
| Lapis Lazuli (TFC)       | `Lapis Lazuli`                                               | y=-20 to y=80 | `Limestone`, `Marble`                                                         | `Andesite` Hint                    | Large, sparse TFC veins.                                         |
| Lapis Lazuli Vein (GT)   | `Lazurite`, `Sodalite`, `Lapis`, `Calcite`                   | y=-65 to y=-30| `Basalt`, `Rhyolite`, `Andesite`, `Dacite`                                    | `Andesite` Hint                    | GT vein for Lapis and related minerals.                          |
| Garnet Vein (GT)         | `Red Garnet`, `Yellow Garnet`, `Amethyst`, `Opal`            | y=-10 to y=50 | `Granite`, `Claystone`                                                        | (Varies by gem)                    | GT source for various gems.                                      |
...
| Salts Vein (GT)          | `Rock Salt`, `Salt`, `Lepidolite`, `Spodumene`                     | y=30 to y=70  | `Shale`, `Claystone`, `Limestone`, `Conglomerate`, `Dolomite`, `Chert`, `Chalk`                       | `Phyllite` Hint (for Halite/Salt)  | GT source of `Salt` and Lithium (`Lepidolite`, `Spodumene`).                                 |
| Mineral Sand Vein (GT)   | `Basaltic Mineral Sand`, `Granitic Mineral Sand`, `Fullers Earth`, `Gypsum` | y=15 to y=60 | `Basalt`, `Granite`                                                                                 | `Quartzite` Hint (for Gypsum)      | GT source of various sands and `Gypsum`.                                                     |
...
| Graphite (TFC Deposit)   | `Graphite`                                                         | y < 60        | `Gneiss`, `Marble`, `Quartzite`, `Schist` (Metamorphic)                                               | `Claystone` Hint                   | Used for Fire Clay. Also found in GT Diamond Veins.                                          |
| Cinnabar (TFC Deposit)   | `Cinnabar`                                                         | Deep          | `Quartzite`, `Granite`, `Phyllite`, `Schist`                                                          | `Gneiss` Hint                      | Ground for Redstone Dust. Also in GT Redstone/Thorium veins.                                 |
| Cryolite (TFC Deposit)   | `Cryolite`                                                         | Deep          | `Granite`, `Diorite` (Igneous Intrusive)                                                              | `Slate` Hint                       | Ground for Redstone Dust.                                                                    |
| Saltpeter (TFC Deposit)  | `Saltpeter`                                                        | Near Surface  | `Shale`, `Claystone`, `Limestone`, `Conglomerate`, `Dolomite`, `Chert`, `Chalk` (Sedimentary)        | `Diorite` Hint                     | Ground for Gunpowder. Large flat deposits.                                                   |
| Sulfur (TFC Deposit)     | `Sulfur`                                                           | Near Lava Lvl | Any Metamorphic (`Quartzite`, `Slate`, etc.) or Igneous Intrusive (`Granite`, `Diorite`, `Gabbro`) | `Shale` Hint                       | Ground for Gunpowder. Sparse but large veins.                                                |
| Sylvite (TFC Deposit)    | `Sylvite`                                                          | Near Surface  | `Shale`, `Claystone`, `Chert` (Sedimentary)                                                         | `Dolomite` Hint                    | Ground for Fertilizer. Large flat deposits.                                                  |
| Borax (TFC Deposit)      | `Borax`                                                            | Near Surface  | `Claystone`, `Limestone`, `Shale` (Sedimentary)                                                     | `Chert` Hint                       | Ground for Flux. Large flat deposits.                                                        |
| Gypsum (TFC Deposit)     | `Gypsum`                                                           | Near Surface  | `Shale`, `Claystone`, `Limestone`, `Conglomerate`, `Dolomite`, `Chert`, `Chalk` (Sedimentary)        | `Quartzite` Hint                   | Decorative (Alabaster). Large flat deposits. Also in GT Mineral Sand Veins.                  |
| Halite (TFC Deposit)     | `Halite` (Rock Salt)                                               | Near Surface  | `Shale`, `Claystone`, `Limestone`, `Conglomerate`, `Dolomite`, `Chert`, `Chalk` (Sedimentary)        | `Phyllite` Hint                    | Ground for Salt (Preservative). Large flat deposits. Also in GT Salts Veins.                 |
