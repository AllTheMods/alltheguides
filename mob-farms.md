...
* **Ars Nouveau - Drygmy Farms:**
  ...
  * [For a specific guide on drygmys click here.](all-the-magic-arcana/arsnouveau/drygmys.md)
* **Evilcraft:**
...
* **Productive Bees:**
  ...
  * _(This method will be detailed in a specific guide later. For the moment, you can check the in-game **Productive Bees** Guide `Big Book of Bees`. You can also refer to the_ [_ATM9 - Productive Bees Guide_](productive-bees.md) _for more information on bees)_.
