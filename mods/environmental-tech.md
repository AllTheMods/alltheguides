...
{% hint style="info" %}
Modifiers also have tiers based on crystal tiers respectively
{% endhint %}
...
Void Miner Drops Based On Lens Mineral Resource Drops
