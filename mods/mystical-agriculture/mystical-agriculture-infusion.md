...
[BEST Mystical Agriculture Farm Design | All The Mods 8](https://www.youtube.com/watch?v=iLSlFHweJsI)
...
[Click here to view Kai’s AE2 guide!](/broken/pages/565bd64bb2153dc268c5729d3d37070ad48bf08d#apotheosis)
...
{% stepper %}
{% step %}
### Place the core components

Place a **Sink/Eternal Water Block** and an **ME Interface** on the corners of a **Quantum Ring** and then place **2x Quartz Fibers/Cable Anchors** on the Quantum Ring, between the Sink and ME Interface you just placed.
...
{% step %}
### Configure the sink storage bus
